...
public class Meditate extends AbstractGorgonCard {

    public static final String ID = GorgonMod.makeID("Meditate");
    public static final String IMG = makeCardPath("Meditate.png");

...
public class BurningEyes extends AbstractGorgonCard {

    public static final String ID = GorgonMod.makeID("BurningEyes");
    public static final String IMG = makeCardPath("BurningEyes.png");

...
public class Bloodshield extends AbstractGorgonCard {

    public static final String ID = GorgonMod.makeID("Bloodshield");
    public static final String IMG = makeCardPath("Bloodshield.png");

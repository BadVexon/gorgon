...
public class Snakebite extends AbstractGorgonCard {

    public static final String ID = GorgonMod.makeID("Snakebite");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        if (m.hasPower(PoisonPower.POWER_ID)) {
            m.getPower(PoisonPower.POWER_ID).flashWithoutSound();
            AbstractDungeon.actionManager.addToBottom(new PoisonLoseHpAction(m, p, m.getPower(PoisonPower.POWER_ID).amount, AbstractGameAction.AttackEffect.POISON));
        }
